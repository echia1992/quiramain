...
const Hero = () => {
    ...
    // Curated list of professional images
    const images = [
    ...
    useEffect(() => {
        const intervalId = setInterval(() => {
            // Increment the current image index with smooth transition
    ...
    return (
        <div className="mt-1"> {/* Adjusted margin to account for fixed navbar */}
            <section className="py-12 bg-gradient-to-b from-white to-gray-50">
                <div className="max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8">
                    <div className="flex-none space-y-6 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
                        ...
                        <p className="text-gray-800 text-4xl font-extrabold md:text-5xl">
                            Elevating Businesses Through Custom Technology Solutions
                        </p>
                        <p className="text-lg text-gray-600">
                            We architect and develop robust software solutions that transform business operations and exceed customer expectations. Our commitment to technical excellence ensures your digital success.
                        </p>
                        <div className="flex flex-col sm:flex-row items-center gap-x-3 space-y-3 sm:space-y-0">
                            <Link href="/service"
                                  className="block py-3 px-6 text-center text-white font-medium bg-indigo-600 duration-150 hover:bg-indigo-500 active:bg-indigo-700 rounded-lg shadow-lg hover:shadow-none w-full sm:w-auto">
                                Start Your Project
                            </Link>
                            <Link href="/contact"
                                  className="flex items-center justify-center gap-x-2 py-3 px-6 text-gray-700 hover:text-gray-500 font-medium duration-150 active:bg-gray-100 border rounded-lg md:inline-flex w-full sm:w-auto">
                                Contact Us
                    ...
                    <div className="flex-none mt-14 md:mt-0 md:max-w-xl relative overflow-hidden rounded-xl shadow-2xl">
                        <Image
                            src={images[currentImage]}
                            className="w-full h-full object-cover transition-opacity duration-1000"
                            alt="Professional working on technology solutions"
                            width={600}
                            height={600}
                            priority
                        />
                ...
                {/* <div className="mt-20 px-4 md:px-8">
                    <p className="text-center text-sm text-gray-700 font-semibold">Trusted by leading companies</p>
...
//                             </h1>
//                             <p className=" text-gray-800 font-extrabold md:text-3xl">
//                                 Elevating Startups and Enterprises: Crafting Applications to Surpass Customer
//                                 Expectations
//                             </p>
//                             <p>
//                                 Leveraging a meticulously crafted software architecture, we are committed to ensuring
//                                 unparalleled customer satisfaction. Our robust logic not only meets but surpasses all
//                                 essential business requirements.
//                             </p>
//                             <div className="items-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
//                                 <Link href="/service"
//                                       className="block py-2 px-4 text-center text-white font-medium bg-indigo-600 duration-150 hover:bg-indigo-500 active:bg-indigo-700 rounded-lg shadow-lg hover:shadow-none">
//                                     Lets get your dream project started
//                                 </Link>
//                                 <Link href="/contact"
...
//                             <Image
//                                 src={images[currentImage]}
//                                 className=" md:rounded-full border-none"
//                                 alt=""
//                                 width={600}
//                                 height={600}
//                             />
